CREATE OR REPLACE FUNCTION shp.dl_req_params(arg_shp_id integer, OUT snd_ca_id integer, OUT snd_addr_id integer, OUT rcv_ca_id integer, OUT rcv_addr_id integer, OUT boxes integer)
 RETURNS record
 LANGUAGE sql
AS $function$
